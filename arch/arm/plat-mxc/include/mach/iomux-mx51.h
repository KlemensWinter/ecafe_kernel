...
#define MX51_PAD_EIM_D31__EIM_D31	IOMUX_PAD(0x42c, 0x098, 0, 0x0,   0, NO_PAD_CTRL)
...
#define MX51_PAD_GPIO_NAND__GPIO_3_12	IOMUX_PAD(0x514, 0x12C, 3 | IOMUX_CONFIG_SION, 0x0,   0, MX51_PAD_CTRL_9)
...
/* FEC */
#define MX51_PAD_EIM_EB2__FEC_MDIO	IOMUX_PAD(0x468, 0x0d4, 3, 0x954, 0, MX51_PAD_CTRL_1 | PAD_CTL_PUS_22K_UP | PAD_CTL_ODE)
#define MX51_PAD_NANDF_CS3__FEC_MDC	IOMUX_PAD(0x524, 0x13C, 2, 0x0, 0, MX51_PAD_CTRL_5)
#define MX51_PAD_EIM_CS3__FEC_RDAT3	IOMUX_PAD(0x480, 0x0ec, 3, 0x964, 0, MX51_PAD_CTRL_2)
...
//#define MX51_PAD_DISP2_DAT14__FEC_RDAT0	IOMUX_PAD(0x794, 0x38c, 2, 0x958, 1, MX51_PAD_CTRL_4)
...
#define MX51_PAD_DISP2_DAT13__FEC_TX_CLK	IOMUX_PAD(0x790, 0x388, 2, 0x974, 1, MX51_PAD_CTRL_2)
//#define MX51_PAD_DISP2_DAT13__FEC_TX_CLK	IOMUX_PAD(0x790, 0x388, 2, 0x974, 1, MX51_PAD_CTRL_4)
#define MX51_PAD_NANDF_RB2__FEC_COL	IOMUX_PAD(0x500, 0x124, 1, 0x94c, 0, MX51_PAD_CTRL_4)
//#define MX51_PAD_NANDF_RB2__FEC_COL	IOMUX_PAD(0x500, 0x124, 1, 0x94c, 0, MX51_PAD_CTRL_2)
#define MX51_PAD_NANDF_RB3__FEC_RXCLK	IOMUX_PAD(0x504, 0x128, 1, 0x968, 0, MX51_PAD_CTRL_4)
//#define MX51_PAD_NANDF_RB3__FEC_RXCLK	IOMUX_PAD(0x504, 0x128, 1, 0x968, 0, MX51_PAD_CTRL_2)
...
#define MX51_PAD_NANDF_D11__FEC_RX_DV	IOMUX_PAD(0x54C, 0x164, 2, 0x96c, 0, MX51_PAD_CTRL_4)
...
#define MX51_PAD_CSI1_VSYNC__GPIO_3_14	IOMUX_PAD(0x5AC, 0x1C4, 3, 0x0, 0, MX51_PAD_CTRL_7)
...
#define MX51_PAD_EIM_D27__AUD6_BB_RXC		IOMUX_PAD(0x41c, 0x088, 5, 0x08f4, 0, MX51_PAD_CTRL_10)
#define MX51_PAD_EIM_D28__AUD6_BB_TXD		IOMUX_PAD(0x420, 0x08c, 5, 0x08f0, 0, MX51_USBH1_PAD_CTRL)
#define MX51_PAD_EIM_D29__AUD6_BB_RXD		IOMUX_PAD(0x424, 0x090, 5, 0x08ec, 0, MX51_USBH1_PAD_CTRL)
#define MX51_PAD_EIM_D30__AUD6_BB_TXC		IOMUX_PAD(0x428, 0x094, 5, 0x08fc, 0, MX51_PAD_CTRL_10 | PAD_CTL_HYS)
#define MX51_PAD_EIM_D31__AUD6_BB_TXFS		IOMUX_PAD(0x42c, 0x098, 5, 0x0900, 0, MX51_PAD_CTRL_10 | PAD_CTL_HYS)
...
#define MX51_PAD_CSPI1_SS1__GPIO_4_25	IOMUX_PAD(0x608, 0x218, 3, 0x0, 0, NO_PAD_CTRL)
...
/* SD3 */
#define MX51_PAD_NANDF_RDY_INT__SD3_CMD	IOMUX_PAD(0x538, 0x150, 5 | IOMUX_CONFIG_SION, 0x0, 0, MX51_SDHC_PAD_CTRL)
#define MX51_PAD_NANDF_CS7__SD3_CLK	IOMUX_PAD(0x534, 0x14C, 5, 0x0, 0, MX51_SDHC_PAD_CTRL | PAD_CTL_HYS)
#define MX51_PAD_NANDF_D8__SD3_DATA0	IOMUX_PAD(0x558, 0x170, 5, 0x93c, 1, MX51_SDHC_PAD_CTRL)
#define MX51_PAD_NANDF_D9__SD3_DATA1	IOMUX_PAD(0x554, 0x16C, 5, 0x940, 1, MX51_SDHC_PAD_CTRL)
#define MX51_PAD_NANDF_D10__SD3_DATA2	IOMUX_PAD(0x550, 0x168, 5, 0x944, 1, MX51_SDHC_PAD_CTRL)
#define MX51_PAD_NANDF_RB0__SD3_DATA3	IOMUX_PAD(0x4F8, 0x11C, 2, 0x948, 0, MX51_SDHC_PAD_CTRL)
#define MX51_PAD_NANDF_D12__SD3_DATA4	IOMUX_PAD(0x548, 0x160, 5, 0x0, 0, MX51_SDHC_PAD_CTRL)
#define MX51_PAD_NANDF_D13__SD3_DATA5	IOMUX_PAD(0x544, 0x15C, 5, 0x0, 0, MX51_SDHC_PAD_CTRL)
#define MX51_PAD_NANDF_D14__SD3_DATA6	IOMUX_PAD(0x540, 0x158, 5, 0x0, 0, MX51_SDHC_PAD_CTRL)
#define MX51_PAD_NANDF_D15__SD3_DATA7	IOMUX_PAD(0x53C, 0x154, 5, 0x0, 0, MX51_SDHC_PAD_CTRL)
...
#define MX51_PAD_GPIO_1_7__GPIO_1_7	IOMUX_PAD(0x810, 0x3E4, IOMUX_CONFIG_SION, 0x0, 0, MX51_SDHC_PAD_CTRL)
#define MX51_PAD_GPIO_1_8__GPIO_1_8	IOMUX_PAD(0x814, 0x3E8, IOMUX_CONFIG_SION, 0x0 , 1, MX51_PAD_CTRL_6)
#define MX51_PAD_GPIO_1_9__GPIO_1_9	IOMUX_PAD(0x818, 0x3EC, IOMUX_CONFIG_SION, 0x0, 0, MX51_PAD_CTRL_9)
