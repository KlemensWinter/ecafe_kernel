...
WFLAGS += -DCONFIG_STA_SUPPORT -DDBG -DRTMP_INTERNAL_TX_ALC
...
ifeq ($(PLATFORM),IMX51)
#WFLAGS += -DRT_BIG_ENDIAN
#EXTRA_CFLAGS := -D__KERNEL__ -I$(CROSS_COMPILE_INCLUDE)/include -I$(LINUX_SRC)/include -I$(RT28xx_DIR)/include -O2 -march=armv7-a -mfpu=neon -mfloat-abi=softfp
#EXTRA_CFLAGS := $(WFLAGS) -I$(RT28xx_DIR)/include -DCONFIG_WEXT_PRIV -DCONFIG_WIRELESS_EXT -O2 -march=armv7-a -mfpu=neon -mfloat-abi=softfp
EXTRA_CFLAGS := $(WFLAGS) -I$(RT28xx_DIR)/include -O2 -march=armv7-a -mfpu=neon -mfloat-abi=softfp
endif
